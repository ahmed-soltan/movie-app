...
import SeriesDetailsCard from "@/pages/tv/components/SeriesDetailsCard";
import AdditionalSeriesDetailsCard from "@/pages/tv/components/AdditionalSeriesDetailsCard";
